...
void Permissions::requestPermissions()
{
        ...
        {
            RequestPermissions = QAndroidJniObject("org/qereb/RequestPermissions",
...
void Permissions::verifyPermissionState()
{
        ...
        QAndroidJniObject stringResult = QAndroidJniObject::callStaticObjectMethod("org/qereb/RequestPermissions",
                                                                                   "getResponseState",
                                                                                   "()Ljava/lang/String;");
...
void registerMobileDeviceTypesPermissions() {
    qmlRegisterType<QObject>();
    qmlRegisterType<Permissions>("AndroidPermissions", 0, 1, "AndroidPermissions");
}

Q_COREAPP_STARTUP_FUNCTION(registerMobileDeviceTypesPermissions)
